...
import {DocumentsTemplatesService} from "@/services/client.service";
...
const DocumentsTemplates = async ({params: {locale}, searchParams}: Props) => {
    const DocumentsTemplates = await DocumentsTemplatesService.getAll(locale.toUpperCase());
    ...
    const tabsPage = generateTabs(DocumentsTemplates || [])

    return (
        <div className="xl:container mx-auto my-16 px-8 max-md:px-4">
            <div className="flex flex-col gap-14 max-sm:gap-8">
                <Title
                    text={titlePage('documentsTemplates')}
