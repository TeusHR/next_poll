...
import {ICreatePageForm, ICreatePublicInformation, IPublicInformationForm} from "@/types/PublicInformation";
import {useLocale} from "next-intl";
import {PublicInformation} from "@/services/CMS.service";


const PublicInformationCreateForm = () => {
    const { handleSubmit, control, formState, reset, getValues, setValue, watch, setError } = useForm<IPublicInformationForm>({
        mode: "all",
        defaultValues: {
            title: "",
        },
    ...
    const onSubmit: SubmitHandler<IPublicInformationForm> = async (dataForm) => {
        ...
        try {
            ...
            const { status, data } = await PublicInformation.postPublicInformation(dataProduct, $apiAuth);
...
export default PublicInformationCreateForm;
