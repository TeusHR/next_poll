...
type Props = {
    ...
    initialData: ILiftGroupConference[]
    showAdd?: boolean
...
const PublicInformationTable: FC<Props> = ({
                                        tableColumn,
                                        initialData,
                                        selectionMode = 'none',
                                        showAdd = false,
    ...
    const [filterData,
        setFilterData] = useState<ILiftGroupConference[]>([])
    ...
    const handleSelectCategories = useCallback(() => {
        let filter: ILiftGroupConference[] = initialData
        if (valueSearch.trim() !== '') {
    ...
    const openCreatePage = useCallback(() => {
        router.push('/cms/public-information/new')
    }, [router])
    ...
    return (
        <>
            <TableItems dataItems={filterData || []}
                        ...
                        rowsViewPage={10}
                        typeProduct='public-information'
...
export default PublicInformationTable;
