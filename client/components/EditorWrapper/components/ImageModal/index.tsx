    ...
    <>
      <Button
        ...
        className={`w-[50px] h-[50px] max-[580px]:max-w-[32px] bg-transparent max-[580px]:min-w-[32px] max-[580px]:h-[32px] max-[580px]:w-[32px]" 
                    ${editor.isActive("image") ? "is-active border-gray-500 solid border-1" : ""}`}
      >
        <svg viewBox="0 0 24 24" className="!w-full !h-[30px] max-[580px]:!h-[20px] ">
                ...
                <div className="flex flex-col w-full">
                  ...
                  >
                    <Tab
                      ...
                      title={
                        <div className="flex items-center space-x-2">
                          <svg viewBox="0 0 24 24" className="!h-[16px] max-[580px]:!h-[13px] ">
                    ...
                    >
                      ...
                      >
                        <div>
                          <span className="font-bold">Drop image</span>
                          <br />
                          or click
                        </div>
                      </DNDUpload>
                    ...
                    >
                      <div className="flex flex-col gap-2 justify-center">
                        ...
                        <div className="text-center">
                          <Button className="px-6 bg-fd text-base" onClick={handleApplyUrl}>
                            Submit
                          </Button>
                        </div>
                      </div>
