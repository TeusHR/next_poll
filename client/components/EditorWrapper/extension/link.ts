...
import {autolink} from "@/components/EditorWrapper/utils/autolink";
import {clickHandler} from "@/components/EditorWrapper/utils/clickHandler";
import {pasteHandler} from "@/components/EditorWrapper/utils/pasteHandler";
import editHyperlinkHelper from "@/components/EditorWrapper/utils/editLink";
 ...
 */
export const LinkEdit = Mark.create<LinkOptions>({
    name: 'link',
