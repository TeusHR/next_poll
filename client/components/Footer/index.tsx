    ...
    return (
        <div className="h-[300px] max-md:h-auto bg-[#17161D] w-full">
            <div className="xl:container mx-auto h-full">
                <div
                    className="grid grid-cols-[repeat(4,minmax(0,max-content))] max-md:grid-cols-[repeat(2,minmax(0,max-content))] max-sm:grid-cols-[repeat(1,minmax(0,max-content))] max-sm:justify-center gap-20 max-xl:gap-10 max-xl:justify-center p-8 pt-24 max-lg:pt-8 h-full items-center text-white text-xl md:text-base">
                    <div className="flex w-full max-sm:justify-center h-full max-lg:items-center">
                        <Image
                            src={'/image/logo.png'}
                            as={NextImage}
                            alt={'ONTU'}
