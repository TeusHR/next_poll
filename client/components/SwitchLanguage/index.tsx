...
const SwitchLanguage:FC<Props> = ({selectLanguage}) => {
  const pathname = usePathname()
  const router = useRouter();

  const handlerOnChange = (keys: React.ChangeEvent<HTMLSelectElement>) => {
    router.replace(pathname, {locale:keys.target.value})
  }
